...
def analyze_content(text):
    ...
    # INCREASED PENALTY AND EXPANDED LIST for better AI detection
    ai_like_phrases = [
        ...
        "leveraging my expertise", "proven track record", "fostered a culture", 
        "driving innovation", "transformative results", "value-added", "collaborative environment" # Expanded list
    ]
    fluff_penalty = sum(1 for ph in ai_like_phrases if ph in text_lower) * 30 # HEAVY penalty to counteract AI-generated structure
